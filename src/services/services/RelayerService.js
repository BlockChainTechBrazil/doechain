...
// Chave privada padrão do relayer (mesma do PetID)
const DEFAULT_RELAYER_KEY = '0x4c2a27080a075b1179788fb491ec041809c22d8e0705241827ad7c23c74a4f9d';

class RelayerService {
  constructor() {
    this.provider = new ethers.JsonRpcProvider(currentNetwork.rpcUrl);

    const privateKey = process.env.RELAYER_PRIVATE_KEY || global.CONFIG?.RELAYER_PRIVATE_KEY || DEFAULT_RELAYER_KEY;
