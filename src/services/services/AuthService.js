...
class AuthService {
   ...
   */
  generateToken(user) {
    const secret = process.env.JWT_SECRET || global.CONFIG?.JWT_SECRET || 'doechain_jwt_secret_key_2026_blockchaintech_brazil';
    const expiresIn = process.env.JWT_EXPIRES_IN || global.CONFIG?.JWT_EXPIRES_IN || '24h';
